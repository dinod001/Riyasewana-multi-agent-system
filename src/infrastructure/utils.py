...
def format_docs(
    docs: list,
    *,
    max_chars_per_doc: Optional[int] = 1500,
    ...
    for i, doc in enumerate(docs, 1):
        ...
        content_full = doc.page_content or ""
        content = (
            content_full
            if (max_chars_per_doc is None or max_chars_per_doc <= 0)
            else content_full[:max_chars_per_doc]
        )
