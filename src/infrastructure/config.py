...
# ========================================
# Active Models (resolved from YAML)
# ========================================
...
SIMILARITY_THRESHOLD = _get_nested(_PARAMS, "retrieval", "similarity_threshold", default=0.5)
...
_QDRANT_COLLECTION_FROM_YAML = _get_nested(_PARAMS, "qdrant", "collection_name", default="riyasewana")
QDRANT_COLLECTION_NAME = os.getenv("QDRANT_COLLECTION_NAME", _QDRANT_COLLECTION_FROM_YAML)
...
def validate() -> None:
    ...
    required_dirs = [DATA_DIR, KB_DIR, LOGS_DIR]
